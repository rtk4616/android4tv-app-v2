 ...
 */
public abstract class A4TVGalleryAbsSpinner extends
        A4TVCoverAdapterView<SpinnerAdapter> {
    ...
    public A4TVGalleryAbsSpinner(Context context) {
        super(context);
        initAbsSpinner();
    }

    public A4TVGalleryAbsSpinner(Context context, AttributeSet attrs) {
    ...
    void recycleAllViews() {
        ...
        final A4TVGalleryAbsSpinner.RecycleBin recycleBin = mRecycler;
