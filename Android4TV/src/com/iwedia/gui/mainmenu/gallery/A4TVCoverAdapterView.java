 ...
 */
public abstract class A4TVCoverAdapterView<T extends Adapter> extends ViewGroup {
    /**
    ...
    public A4TVCoverAdapterView(Context context) {
        super(context);
    }

    public A4TVCoverAdapterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(A4TVCoverAdapterView<?> parent, View view,
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(A4TVGallery coverFlow, View view, int position,
                long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(A4TVCoverAdapterView<?> parent, View view,
                int position, long id);
         ...
         */
        void onNothingSelected(A4TVCoverAdapterView<?> parent);
    }
     ...
     * 
     * @param view
     *        an adapter item, or a descendant of an adapter item. This must be
     *        visible in this AdapterView at the time of the call.
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (A4TVCoverAdapterView.this.getAdapter().hasStableIds()
                    && mInstanceState != null && mOldItemCount == 0
                    && mItemCount > 0) {
                A4TVCoverAdapterView.this
        ...
        public void onInvalidated() {
            ...
            if (A4TVCoverAdapterView.this.getAdapter().hasStableIds()) {
                ...
                mInstanceState = A4TVCoverAdapterView.this
                        .onSaveInstanceState();
            }
     ...
     * 
     * @param position
     *        Intended value for mSelectedPosition the next time we go through
     *        layout
     */
