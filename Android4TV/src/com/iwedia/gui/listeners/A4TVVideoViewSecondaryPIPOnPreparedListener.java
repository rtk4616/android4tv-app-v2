...
public class A4TVVideoViewSecondaryPIPOnPreparedListener extends
        A4TVVideoViewOnPreparedListener implements OnPreparedListener {
    public static final String LOG_TAG = "A4TVVideoViewSecondaryPIPOnPreparedListener";
    private A4TVVideoView videoView;
    private Content contentToPlay;

    public A4TVVideoViewSecondaryPIPOnPreparedListener(A4TVVideoView videoView,
            Content content) {
        super();
