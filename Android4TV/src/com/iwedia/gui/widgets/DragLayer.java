...
public class DragLayer extends MyAbsoluteLayout implements DragSource,
    ...
    */
    ...
    public void onDropCompleted(View target, boolean success) {
        // Log.d("ON DRAG COMPLETED", "ENTERED");
        //
        // int[] locationOnScreen = new int[2];
        // target.getLocationOnScreen(locationOnScreen);
        //
        // Log.d("END X", locationOnScreen[0] + "");
        // Log.d("END Y", locationOnScreen[1] + "");
    }
    ...
    */
     ...
     * @param xOffset
     *        Horizontal offset with the object being dragged where the original
     *        touch happened
     * @param yOffset
